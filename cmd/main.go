...
import (
	...
	"github.com/arbha1erao/configmap-sync-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(configsyncv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5897a032.example.com",
